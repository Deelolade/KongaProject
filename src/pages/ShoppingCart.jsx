                        ...
                        <div className='d-flex shopCartContainer  mx-auto '>
                            <div className='left-shopCart  '>
                                <div className='p-sm-3 p-2 order-Summary fw-bolder d-lg-none'>
                                    <span>SubTotal({getTotalItems()} {getTotalItems().length === 1 ? 'item' : 'items'})</span>
                                    <span> # {totalPrice.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</span>
                                </div>
                                <div className="left-shopCartTop py-2 px-3 mx-auto d-flex justify-content-between gap-2 align-items-center d-none d-sm-flex">
                                    <div className="item-details flex-grow-1 text-start">
                                        <span>Items Details</span>
                                    </div>
                                    <div className="quantityItem flex-grow-1 text-center me-md-5 pe-md-5 pe-lg-0 me-lg-0">
                                ...
                                {(
                                    cart.map(item => (
                                        <div key={item.id} className='pt-2 pb-1 px-3 px-md-2 px-lg-3 d-flex mx-auto justify-content-between align-items-center itemMainContainer'>
                                            <div className=" d-flex  justify-content-evenly " style={{ width: "auto" }} >
                                                <div className="">
                                                    <div className=' itemContainer d-flex flex-column flex-md-row justify-content-between ' style={{ width: "100%", }}>
                                                        ...
                                                        <div className="d-flex justify-content-start align-item-center list-quantity ">
                                                        ...
                                                        <div className='removeCont  d-flex  text-lg-end text-md-end ms-md-4   '>
                            ...
                            <div className='right-shopCart shadow rounded col-3 d-none  ms-3 d-lg-block'>
