    ...
    return (
        <div>
            <div className=' mt-5' style={{ width: "1440px" }}>
                <div className='sameDayDeliveryHeading rounded-2 mx-md-1 py-sm-3 px-sm-3 text-dark d-flex align-items-center justify-content-between'>
                    <div className=" d-flex same-day justify-content-center align-items-center">
                        <h5 className=" ms-md-3 ms-2 fw-bold my-auto KongaNow ">Same Day Delivery(KongaNow)</h5>
                        <div className="">
                            <a href="#" className="ms-sm-3  text-decoration-none fw-medium seeAllItemsSameDay" style={{ fontSize: '12px', color: '#8F054D' }}>See All Items</a>
                        </div>
                    </div>
                    <div className=''>
