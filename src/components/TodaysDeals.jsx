                                ...
                                <div className="row g-0 productsShadows" role='button'>
                                    ...
                                    <div className="col-md-8">
                                        <div className="card-body">
                                            ...
                                            <h5 className="card-text fw-bold">₦22,896 <span className='fs-6 fw-light ms-4'>₦</span><span className='fs-6 fw-light text-decoration-line-through'>26,200</span><span className='bg-danger-subtle text-danger fw-medium ms-4 rounded-3 py-1' style={{ fontSize: '10px' }}> - 13%</span></h5>
                                ...
                                <div className="row g-0 productsShadows" role='button'>
                                    ...
                                    <div className="col-md-8">
                                        <div className="card-body">
                                            ...
                                            <h5 className="card-text fw-bold">₦83,307 <span className='fs-6 fw-light ms-4'>₦</span><span className='fs-6 fw-light text-decoration-line-through'>94,900</span><span className='bg-danger-subtle text-danger fw-medium ms-3 rounded-3 py-1' style={{ fontSize: '10px' }}> - 12%</span></h5>
                                ...
                                <div className="row g-0 productsShadows" role='button'>
                                    ...
                                    <div className="col-md-8">
                                        <div className="card-body">
                                            ...
                                            <h5 className="card-text fw-bold">₦23,939 <span className='fs-6 fw-light ms-4'>₦</span><span className='fs-6 fw-light text-decoration-line-through'>27,400</span><span className='bg-danger-subtle text-danger fw-medium ms-3 rounded-3 py-1' style={{ fontSize: '10px' }}> - 13%</span></h5>
                                ...
                                <div className="row g-0 productsShadows" role='button'>
                                    ...
                                    <div className="col-md-8">
                                        <div className="card-body">
                                            ...
                                            <h5 className="card-text fw-bold">₦16,958 <span className='fs-6 fw-light ms-4'>₦</span><span className='fs-6 fw-light text-decoration-line-through'>19,400</span><span className='bg-danger-subtle text-danger fw-medium ms-3 rounded-3 py-1' style={{ fontSize: '10px' }}> - 13%</span></h5>
