  ...
  return (
    <div className=' '>
      <nav className="navbar navbar-expand">
        <div className=" d-flex justify-content-center align-items-center mx-auto main-nav">
          ...
          <div className="collapse navbar-collapse justify-content-around" id="navbarSupportedContent">
            ...
            </ul> <form className="d-flex mx-lg-3 mx-md-1 justify-content-center align-items-center" role="search" onSubmit={handleSubmit}>
            ...
            <span className='cart-icon' style={{ width: "auto", height: "auto", fontSize: "15px" }}>
